...
namespace _06_RepositoryPattern_Repository
{
    ...
    {
        private List<StreamingContent> _listOfContent = new List<StreamingContent>();  //fields have underscore prefix and camelCase

        //Create (return type is void bc we're only creating)
